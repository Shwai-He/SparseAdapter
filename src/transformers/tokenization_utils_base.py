...
class SpecialTokensMixin:
    ...
    def sep_token(self, value):
        self._sep_token = value if not type(value) == int else self.decoder[value]

    @pad_token.setter
    def pad_token(self, value):
        self._pad_token = value if not type(value) == int else self.decoder[value]

    @cls_token.setter
    def cls_token(self, value):
        self._cls_token = value if not type(value) == int else self.decoder[value]

    @mask_token.setter
    def mask_token(self, value):
        self._mask_token = value if not type(value) == int else self.decoder[value]
    ...
    def bos_token_id(self, value):
        self._bos_token = self.convert_tokens_to_ids(value) if not type(value) == int else self.decoder[value]

    @eos_token_id.setter
    def eos_token_id(self, value):
        self._eos_token = self.convert_tokens_to_ids(value) if not type(value) == int else self.decoder[value]

    @unk_token_id.setter
    def unk_token_id(self, value):
        self._unk_token = self.convert_tokens_to_ids(value) if not type(value) == int else self.decoder[value]

    @sep_token_id.setter
    def sep_token_id(self, value):
        self._sep_token = self.convert_tokens_to_ids(value) if not type(value) == int else self.decoder[value]

    @pad_token_id.setter
    def pad_token_id(self, value):
        self._pad_token = self.convert_tokens_to_ids(value) if not type(value) == int else self.decoder[value]

    @cls_token_id.setter
    def cls_token_id(self, value):
        self._cls_token = self.convert_tokens_to_ids(value) if not type(value) == int else self.decoder[value]

    @mask_token_id.setter
    def mask_token_id(self, value):
        self._mask_token = self.convert_tokens_to_ids(value) if not type(value) == int else self.decoder[value]

    @additional_special_tokens_ids.setter
    def additional_special_tokens_ids(self, values):
        self._additional_special_tokens = [self.convert_tokens_to_ids(value) if not type(value) == int else self.decoder[value] for value in values]
