...
sparsity=1.
metric=exact_match
SAVE=./checkpoints/${model_name_or_path}/${DATE}/${pruner}_${sparsity}_${attn_mode}_${attn_option}_${attn_bn}_${ffn_mode}_${ffn_option}_${ffn_bn}
echo "${SAVE}"
mkdir -p ${SAVE}
...
nohup python ./run_qa.py \
      ...
      --attn_mode ${attn_mode} --attn_option ${attn_option} --attn_composition add --attn_bn ${attn_bn} \
      ...
      --weight_decay ${weight_decay} --metric_for_best_model ${metric} \
